  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="author"
          content="https://github.com/CypherVerseLabs"
        />
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="cybuilder, 3d, webxr, 3d website, framework, npm"
        />
        ...
        <meta
          property="og:url"
          content="https://www.cypherverse.space"
        />
        ...
        <meta
          property="og:image"
          content="/android-chrome-512x512.ico"
        />
