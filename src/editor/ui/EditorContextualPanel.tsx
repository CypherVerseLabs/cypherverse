...
const SCENE_OBJECT_TYPES = new Set<string>([
  "ground",
  "cloudySky",
  "rain",
  "toxicGass",
...
type ModifierDefinition = {
  type: SceneObjectModifier["type"];
  name: string;
  description: string;
};

type EffectDefinition = {
  type: SceneObjectEffect["type"];
  name: string;
  description: string;
};
...
const MODIFIER_DEFINITIONS: ModifierDefinition[] = [
  {
    ...
    name: "Orbiting",
    description:
      "Makes the selected object orbit around its local center.",
  },
];
...
const EFFECT_DEFINITIONS: EffectDefinition[] = [
  {
    ...
    name: "Bloom",
    description:
      "Stores the Bloom effect on the selected object.",
  },
];
...
function AddIdeasPanel({
  ...
  const addModifier =
    (
      ...
      const modifier: SceneObjectModifier =
        {
          type: "orbiting",
          props: {
            radius: 2,
  ...
  const addEffect =
    (
      ...
      const effect: SceneObjectEffect =
        {
          type: "bloom",
          props: {
            strength: 0.1,
